//! solution for https://adventofcode.com/2015/day/20 part 1
...
pub fn main() !void
{
    ...
    const _maxHouses: usize = totalPresents / 10; // granted to have enough houses
    ...
    for (1..maxHouses+1) | elf | // taking elf by elf
    {
        ...
        while (houseIndex <= maxHouses) : (houseIndex += elf) { houses.items[houseIndex] += 10 * elf; }
    }
