//! solution for https://adventofcode.com/2015/day/21 part 2
...
var highestCost:i32 = 0; // highest cost with defeat
    ...
    {    
        for (0..6) | a | // armor index
        {
            for (0..7) | r | // ring1 index
            {
                ...
                {        
                    const costOfDefeat = shopAndFight(w, a, r, s);
                    
                    if (costOfDefeat == null) { continue; }

                    if (costOfDefeat.? > highestCost) { highestCost = costOfDefeat.?; } 
                }
            }
        }
    }
