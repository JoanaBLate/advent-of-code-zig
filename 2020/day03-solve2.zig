//! solution for https://adventofcode.com/2020/day/03 part 2
...
pub fn main() !void
{
    ...
    const travelA: u32 = travel(1, 1);
    const travelB: u32 = travel(1, 3);
    const travelC: u32 = travel(1, 5);
    const travelD: u32 = travel(1, 7);
    const travelE: u32 = travel(2, 1);
    
    print("answer: {}\n", .{ travelA * travelB * travelC * travelD * travelE });
}

fn travel(deltaRow: u32, deltaCol: u32) u32
{
